...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = __webpack_require__(100);
	var expressWinston = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRootIndex = __webpack_require__(69);
...
/***/ function(module, exports) {
	...
	module.exports = require("fluxxor");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requester = __webpack_require__(95);
	var _ = __webpack_require__(33);
	var auth = __webpack_require__(18).auth;
	...
	var api = {
	    ...
	    getMoviesByRank: function getMoviesByRank(startRankIndex, numMovies) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieStore = Fluxxor.createStore({
	    ...
	    initialize: function initialize() {
	        ...
	        this.bindActions(constants.ADD_MOVIES, this.onAddMovies);
	    },
	
	    onAddMovies: function onAddMovies(payload) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = {
	    addMovies: function addMovies(movies) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fluxxor = __webpack_require__(25);
	var MovieStore = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxMixin = Fluxxor.FluxMixin(React);
	var StoreWatchMixin = Fluxxor.StoreWatchMixin;
	var MovieCard = __webpack_require__(86);
	var _ = __webpack_require__(33);
	var StyleSheet = __webpack_require__(173);
	...
	var FrontPage = React.createClass({
	    ...
	    expandMovie: function expandMovie(id) {
	    ...
	    topTen: function topTen() {
	        ...
	        this.state.topTen.map(function (movie, i) {
	            movies.push(React.createElement(
	                'li',
	                { className: 'title', key: i, onClick: self.expandMovie.bind(self, i) },
	                React.createElement(
	                    'span',
	                    { className: 'rank' },
	                    movie.Rank,
	                ...
	                React.createElement(MovieCard, _extends({}, movie, { hide: self.state.visible[i] }))
	            ));
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppTemplate = __webpack_require__(94);
	
	//pages
	var FrontPage = __webpack_require__(91);
	var Research = __webpack_require__(92);
	var Booking = __webpack_require__(90);
	...
	module.exports = _react2.default.createElement(
	    _reactRouter.Route,
	    { component: AppTemplate, path: '/' },
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: FrontPage }),
	    _react2.default.createElement(_reactRouter.Route, { component: Research, path: '/research' }),
	    _react2.default.createElement(_reactRouter.Route, { component: Booking, path: '/booking' })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requester = function requester(method, url, queryParams, body) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//server side only
	var winston = __webpack_require__(177);
	var deepMerge = __webpack_require__(175);
	var isIntProd = ("development") === 'production' || ("development") === 'integration';
	var logLevel = __webpack_require__(18).server.logging.logLevel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(18);
	var FluxConstructor = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; }; //server/middleware/react.js
	...
	var reactMiddleWare = function reactMiddleWare(req, res, next) {
	    ...
	    (0, _reactRouter.match)({ routes: _routes2.default, location: req.originalUrl }, function (error, redirectLocation, renderProps) {
	        if (error) {
	            ...
	            (function () {
	                ...
	                // collect promises
	                promises = [api.getMovies().catch(function (err) {
	                    throw err;
	                }).then(function (result) {
	                ...
	                renderProps.components.forEach(function (route) {
	                    console.log('route serverMount', _typeof(route.serverMount));
	                ...
	                Promise.all(promises).catch(function (err) {
	                    ...
	                    var markup = (0, _server.renderToString)(_react2.default.createElement(_reactRouter.RouterContext, _extends({}, renderProps, { createElement: createFluxComponent })));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flux = __webpack_require__(97);
	var reactMiddleware = __webpack_require__(98);
	//var errorHandler = require('../middleware/error-handler');
	
	router.route('/*').get(flux, //add flux to res.locals
...
/***/ function(module, exports, __webpack_require__) {
	...
	// use these routes
	router.use(__webpack_require__(99));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findDOMNode = __webpack_require__(72);
	var focusNode = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginHub = __webpack_require__(19);
	var ReactComponentEnvironment = __webpack_require__(38);
	var ReactClass = __webpack_require__(116);
	var ReactEmptyComponent = __webpack_require__(61);
	var ReactBrowserEventEmitter = __webpack_require__(27);
	var ReactNativeComponent = __webpack_require__(67);
	var ReactPerf = __webpack_require__(6);
...
/***/ function(module, exports) {
	...
	module.exports = require("deep-merge");
